  ...
  return (
    <div className={clsx('col col--4')}>
      <div className="text--center padding-horiz--md">
        <h3 style={{ fontFamily: 'Sora, sans-serif' }}>{title}</h3>
        <p>{description}</p>
      </div>
    </div>
  );
        ...
        <div className="container padding-vert--lg">
          ...
          <div className="row padding-vert--md counter-section" style={{backgroundColor: 'transparent', borderRadius: '8px', margin: '20px 0'}}>
            <div className="col col--3 text--center">
              <h3 style={{fontFamily: 'Sora, sans-serif', color: '#25c19f'}}>19</h3>
              <p>Modules</p>
            </div>
            <div className="col col--3 text--center">
              <h3 style={{fontFamily: 'Sora, sans-serif', color: '#25c19f'}}>50+</h3>
              <p>Subpages</p>
            </div>
            <div className="col col--3 text--center">
              <h3 style={{fontFamily: 'Sora, sans-serif', color: '#25c19f'}}>10k+</h3>
              <p>Students</p>
            </div>
            <div className="col col--3 text--center">
              <h3 style={{fontFamily: 'Sora, sans-serif', color: '#25c19f'}}>24/7</h3>
              <p>Support</p>
            </div>
          </div>
          ...
          <div className="row padding-vert--md" id="testimonials">
            <div className="col col--12">
              <h2 className="testimonials" style={{fontFamily: 'Sora, sans-serif', textAlign: 'center'}}>What Our Users Say</h2>
              <div className="row">
                <div className="col col--4">
                  <div style={{padding: '20px', border: '1px solid #555', borderRadius: '8px', backgroundColor: 'transparent'}}>
                    <p>"This textbook provided the comprehensive foundation I needed to start my robotics research."</p>
                    <p><em>- Graduate Student</em></p>
                  </div>
                </div>
                <div className="col col--4">
                  <div style={{padding: '20px', border: '1px solid #555', borderRadius: '8px', backgroundColor: 'transparent'}}>
                    <p>"The practical examples and theoretical background perfectly complement each other."</p>
                    <p><em>- Robotics Engineer</em></p>
                  </div>
                </div>
                <div className="col col--4">
                  <div style={{padding: '20px', border: '1px solid #555', borderRadius: '8px', backgroundColor: 'transparent'}}>
                    <p>"An invaluable resource for anyone serious about Physical AI and Humanoid Robotics."</p>
                    <p><em>- Professor</em></p>
                  </div>
                </div>
              </div>
          ...
          <div className="row padding-vert--md">
            <div className="col col--12">
              ...
              <div style={{padding: '20px', border: '1px solid #555', borderRadius: '8px', backgroundColor: 'transparent', marginBottom: '10px'}}>
                ...
                <p>This textbook is designed for students, researchers, and professionals working in robotics, AI, or related fields who want to understand the principles of Physical AI and Humanoid Robotics.</p>
              </div>
              <div style={{padding: '20px', border: '1px solid #555', borderRadius: '8px', backgroundColor: 'transparent', marginBottom: '10px'}}>
                <h3>Do I need prior robotics experience?</h3>
                <p>While some background in programming and basic robotics concepts is helpful, this textbook is structured to be accessible to motivated learners at various levels.</p>
              </div>
              <div style={{padding: '20px', border: '1px solid #555', borderRadius: '8px', backgroundColor: 'transparent', marginBottom: '10px'}}>
                <h3>How is this textbook different?</h3>
                <p>Unlike traditional robotics textbooks, this resource specifically focuses on the intersection of AI and physical systems, with emphasis on embodied intelligence and humanoid systems.</p>
              </div>
            </div>
          </div>
        </div>
